...
<body>
		...
		<div class="container">
			...
			<div class="d-flex  d-block">
				<img alt="" class="rounded mx-auto d-block"
					src="<%=request.getContextPath()%>/resources/img/trophy_gold.png"
					width="50" height="50" /><span
					class="badge badge-white
            py-3">9</span> <img alt=""
					class="rounded mx-auto d-block"
					src="<%=request.getContextPath()%>/resources/img/trophy_silver.png"
					width="50" height="50" /><span
					class="badge badge-white
            py-3">8</span> <img alt=""
					class="rounded mx-auto d-block"
					src="<%=request.getContextPath()%>/resources/img/trophy_bronze.png"
					width="50" height="50" /><span
					class="badge badge-white
            py-3">7</span>
	...
	<div class="container my-5">
		...
		<ul class="nav nav-tabs nav-justified" id="lista-menu">
			<li class="nav-item"><a
				class="nav-link active border font-weight-bold"
				style="font-family: Gravity;" data-toggle="tab" href="#mural">
					Mural </a></li>
			<li class="nav-item"><a class="nav-link border font-weight-bold"
				style="font-family: Gravity;" data-toggle="tab" href="#atividades">
					Atividades </a></li>
			<li class="nav-item"><a
				class="nav-link  border font-weight-bold"
				style="font-family: Gravity;" data-toggle="tab"
				href="#participantes"> Participantes </a></li>
		</ul>
		...
		<div class="tab-content bg-white">
					...
					<div class="card gedf-card">
						...
						<div class="card-body">
							<p class="card-text">Lorem ipsum dolor sit amet consectetur
								...
								esse magnam nemo dolor sequi fuga quia quaerat cum, obcaecati
								hic, molestias minima iste voluptates.</p>
						</div>
					...
					<div class="card gedf-card">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-8">
									<p class="card-text">Lorem ipsum dolor sit amet consectetur
										adipisicing elit. Quo recusandae nulla rem eos ipsa
										praesentium esse magnam nemo dolor sequi fuga quia quaerat
										cum, obcaecati hic, molestias minima iste voluptates.</p>
								</div>
							</div>
						</div>
			...
			<div class="tab-pane fade container border shadow p-4"
				id="atividades">
